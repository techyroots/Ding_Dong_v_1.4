...
public class ApiRequest {
    ...
    public static void Call_Api (final Context context, final String url, JSONObject jsonObject,
        ...
        if(!Variables.is_secure_info) {
            ...
            Log.e(Variables.tag, url);

            if (jsonObject != null)
                Log.e("JSON_object_"+Variables.tag + urlsplit[urlsplit.length - 1], jsonObject.toString());
        }
         ...
         JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(!Variables.is_secure_info) {
                            final String[] urlsplit = url.split("/");
                            Log.e("RESPONSE_"+Variables.tag + urlsplit[urlsplit.length - 1], response.toString());
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                if(!Variables.is_secure_info) {
                    final String[] urlsplit = url.split("/");
                    Log.e("ERROR_"+Variables.tag + urlsplit[urlsplit.length - 1], error.toString());
                }
             ...
             public Map<String, String> getHeaders() throws AuthFailureError {
                 ...
                 Log.e("HEADERS_"+Variables.tag,headers.toString());
                 return headers;
             }
         };
