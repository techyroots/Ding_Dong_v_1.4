...
public class Variables {
    ...
    public static String tag="dingdong_";
  ...
  public static String gif_api_key1="giphy_api_key_here";
    ...
    public static final String privacy_policy="http://phpstack-434987-1362820.cloudwaysapps.com/privacy/Privacy.txt";


   

    public static String base_url="http://phpstack-434987-1362820.cloudwaysapps.com/admin/API/";
    ...
    public static final String downloadFile=domain+"downloadFile";
